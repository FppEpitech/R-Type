...
SceneManager::ServerSceneManager::ServerSceneManager(std::shared_ptr<std::vector<ECS::Registry>> registries)
{
...
void SceneManager::ServerSceneManager::_loadScene(const std::string &path, std::size_t registerIndex)
{
...
void SceneManager::ServerSceneManager::_loadSceneKeys(Json::Value root, std::size_t index)
{
...
void SceneManager::ServerSceneManager::_loadSceneComponents(Json::Value root, std::size_t index)
{
...
void SceneManager::ServerSceneManager::_loadSceneSystems(Json::Value root, std::size_t index)
{
