...
class LogoutHandler : public AEventHandler {

    public:

        /**
         * @brief Construct a new LogoutHandler object
         *
         * @param eventType Event type
         */
        LogoutHandler(std::string eventType = "");

        /**
         * @brief Destroy the LogoutHandler object
         *
         */
...
class LogoutHandlerError : public AError {

    public:

        /**
         * @brief Construct a new LogoutHandlerError object
         *
         * @param message Message
         */
        LogoutHandlerError(std::string message) : AError(message) {}
};
