...
#include "RoomNameTextBoxInitSystem.hpp"

RoomNameTextBoxInitSystem::RoomNameTextBoxInitSystem() :
...
void RoomNameTextBoxInitSystem::_initButton(ECS::Registry& reg, int idxPacketEntities)
{
...
extern "C" {
    EXPORT_SYMBOL ISystem* loadSystemInstance() {
        return new RoomNameTextBoxInitSystem();
    }
}
