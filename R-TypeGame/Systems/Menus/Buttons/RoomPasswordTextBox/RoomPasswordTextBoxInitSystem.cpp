...
** R-Type
** File description:
** RoomPasswordTextBoxInitSystem.cpp
*/
...
#include "RoomPasswordTextBoxInitSystem.hpp"

RoomPasswordTextBoxInitSystem::RoomPasswordTextBoxInitSystem() :
...
void RoomPasswordTextBoxInitSystem::_initButton(ECS::Registry& reg, int idxPacketEntities)
{
    ...
    std::shared_ptr<EditableComponent> editable = std::make_shared<EditableComponent>(false);
