...
#include "UsernameTextBoxInitSystem.hpp"
#include "ButtonStateComponent.hpp"
#include "DefaultTextComponent.hpp"

UsernameTextBoxInitSystem::UsernameTextBoxInitSystem() :
...
void UsernameTextBoxInitSystem::_initButton(ECS::Registry& reg, int idxPacketEntities)
{
...
extern "C" {
    EXPORT_SYMBOL ISystem* loadSystemInstance() {
        return new UsernameTextBoxInitSystem();
    }
}
